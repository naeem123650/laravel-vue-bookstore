  ...
  <div class="row">
    <div class="col-sm-12">
      <div class="card">
        ...
        <div class="card-body">
          <form @submit.prevent="uptBook" enctype="multipart/form-data">
            <div class="row">
              ...
              <div class="col-sm-6 mt-3">
                <div class="custom-control custom-switch">
                  <input
                    ...
                    id="published"
                    :checked="form.published ? true : false"
                  />
...
export default {
  ...
  computed: {
    ...
    form() {
      return this.$store.getters.getSingleBook;
    },
  },
  methods: {
    onImageChange(e) {
  ...
  created() {
    this.$store.dispatch("findBook", this.id);
  },
};
</script>
